...
from shared.contracts import JSONObject, JSONValue, StoryDocument, StoryListItem, StorySaveResult, StoryValidationIssue
...
try:
    ...
    from shared.cache import clear_caches as _clear_story_cache
except Exception:
