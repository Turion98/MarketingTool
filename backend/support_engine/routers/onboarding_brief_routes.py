...
from support_engine.services.onboarding.anthropic_client import AnthropicOnboardingClient
from support_engine.services.onboarding.brief_contracts import (
    EndNodeKind,
    SupportChatbotBrief,
)
from support_engine.services.onboarding.contracts import OnboardingJob, RetryConfig
from support_engine.services.onboarding.end_node_text_generator import EndNodeTextClient
from support_engine.services.onboarding.event_bus import EventBus
from support_engine.services.onboarding.onboarding_coach import CoachRequest, CoachResponse, run_coach
from support_engine.services.onboarding.orchestrator import (
    OnboardingOrchestrator,
    OrchestratorError,
)
from support_engine.services.onboarding.storage import JobNotFound, OnboardingStorage
...
def update_brief(
    ...
    from support_engine.services.onboarding.brief_expander import expand_brief_to_research
