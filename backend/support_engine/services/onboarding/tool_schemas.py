...
1. A Pydantic kontraktok (`support_engine.services.onboarding.contracts`) második védvonal;
...
from support_engine.services.onboarding.constraints import ConstraintCatalog
...
def _routing_rule_oneof_schema() -> dict[str, Any]:
    ...
    `decision_engine.services.story_runtime.resolve_ai_node_routing` kétmenetes
...
# (support_engine.services.onboarding.contracts.SemanticIssueKind) az igazságforrás —
