...
class AnthropicOnboardingClient:
    ...
    def generate_end_node_texts(
        ...
        *,
        ...
        A prompt-építés a hívó (`support_engine.services.onboarding.end_node_text_generator.
    ...
    def coach_reply(
        ...
        *,
        ...
        from support_engine.services.onboarding.onboarding_coach import build_coach_tool
