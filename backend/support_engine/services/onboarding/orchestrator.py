...
- `shared.story_lint.lint_full_story` és `lint_single_node` (validáció)
- `support_engine.services.onboarding.contracts` (Pydantic modellek)
- `support_engine.services.onboarding.storage.OnboardingStorage` (perzisztencia)
- `support_engine.services.onboarding.event_bus.EventBus` (in-memory pub-sub)
- `support_engine.services.onboarding.tool_schemas` (csak konvencionálisan, mert a
...
from support_engine.services.onboarding.text_triggers_generator import (
    TextTriggersClient,
    generate_text_triggers_for_story,
)
from support_engine.services.onboarding.storage import OnboardingStorage
from shared.story_lint import lint_full_story, lint_single_node
...
class OnboardingClient(Protocol):
    ...
    `support_engine.services.onboarding.tool_schemas` builderein keresztül beszél;
...
def assemble_story(
    *,
    ...
    `support_engine.services.onboarding.cross_node_linker.link_cross_nodes` determinisztikus
    ...
    `support_engine.services.onboarding.meta_builder.apply_meta_builder` deterministically
    ...
    `support_engine.services.onboarding.step_enricher.apply_step_enricher`. Ez minden
